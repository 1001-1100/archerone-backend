...
from .models import College, Cart, FriendRequest, Notification, Degree, Course, Faculty, FlowchartTerm, Section, Building, Room, Day, Timeslot, CourseOffering, CoursePriority, Schedule, User, Preference
