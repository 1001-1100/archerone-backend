...
urlpatterns = [
    ...
    path('api/friendlist/<int:pk>/<int:user>/', views.FriendList.as_view()),     
    ...
    path('api/sentrequestlist/<int:pk>/<int:user>/', views.SentRequestList.as_view()),     
    path('api/nonfriendlist/<int:pk>/<int:user>', views.NonFriendList.as_view()),     
